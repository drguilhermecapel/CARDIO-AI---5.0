        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center gap-5">
            ...
            <div className="relative w-12 h-12 flex items-center justify-center group cursor-pointer">
              <div className="absolute inset-0 bg-cyan-500/10 rounded-lg rotate-45 border border-cyan-500/20 animate-pulse group-hover:bg-cyan-500/20 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)]"></div>
              ...
              <div className="absolute -inset-1 border border-cyan-500/10 rounded-lg rotate-12 group-hover:rotate-45 transition-transform duration-700"></div>
            </div>
            
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                <span className="text-2xl font-black text-white tracking-tighter uppercase italic">Cardio</span>
                <span className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-magenta-400 neon-text-glow uppercase italic">AI</span>
              </div>
              <span className="text-[9px] text-cyan-500/50 font-mono font-black uppercase tracking-[0.5em] -mt-1">Quantum Diagnostic Core</span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-12">
             <div className="flex flex-col items-end gap-1">
               ...
               <span className="text-[8px] text-slate-500 font-mono uppercase tracking-widest font-black">Neural Link: Active</span>
             </div>
